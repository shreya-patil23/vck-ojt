    ...
    <div className="back">
      <Header/>
        ...
        <h1>Contact Us</h1>
         ...
         <h1 className="line">General Enquiries</h1>
        ...
        <p> Office Hours: Monday - Friday, 9:00 AM - 5:00 PM IST </p>
         <h1 className="line">Admissions Office</h1>
         ...
         <p> Email: admissions@vivekanandcollege.edu</p>
          <h1 className="line">Student Support Services</h1>
          ...
          <p>Email: studentsupport@vivekanandcollege.edu</p> 
           <h1 className="line">Find Us on the Map</h1>
           ...
           <h1 className="line">Send Us a Message</h1>
